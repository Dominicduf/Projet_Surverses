...
def map_hover_template():
    ...
    string = "<b><span style=\"font-family:Oswald;font-size:24px\">%{customdata[0]}</span></b><extra></extra><br><br>"\
...
def linechart_dure_hover_template():
    '''
        Sets the template for the hover tooltips on the neighborhoods.
    ...
    '''
    # TODO : Generate the hover template
    string = "<b>Année:</b> %{x}<br>"\
    "<b>Duré de débordement:</b> %{y}<br>"\
    "<extra></extra>"
    return string

def linechart_freq_hover_template():
    '''
        Sets the template for the hover tooltips on the neighborhoods.
